...
OpenCode does not use one static system prompt. The primary prompt is assembled at runtime from:

- `packages/opencode/src/session/llm.ts`: joins the agent prompt or provider prompt, runtime system context, and per-message custom system text.
- `packages/opencode/src/session/system.ts`: picks a provider/model-specific prompt file.
- `packages/opencode/src/session/prompt/*.txt`: source prompt files used by the provider selector.
- `AGENTS.md`, `CLAUDE.md`, configured instruction files, environment metadata, and skill descriptions: appended dynamically outside the provider prompt.
...
Source path: `packages/opencode/src/session/prompt.ts`
...
Source path: `packages/opencode/src/session/system.ts`
...
Source path: `packages/opencode/src/session/prompt/default.txt`
...
Source path: `packages/opencode/src/session/prompt/gpt.txt`
...
Source path: `packages/opencode/src/session/prompt/codex.txt`
...
Source path: `packages/opencode/src/session/prompt/anthropic.txt`
...
Source path: `packages/opencode/src/session/prompt/gemini.txt`
...
Source path: `packages/opencode/src/session/prompt/kimi.txt`
...
Source path: `packages/opencode/src/session/prompt/beast.txt`
...
Source path: `packages/opencode/src/session/prompt/trinity.txt`
